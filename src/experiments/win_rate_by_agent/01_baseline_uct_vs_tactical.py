...
SIMULATIONS = 500
SEEDS = range(0, 100)
SIDE_MODE = "alternate"  # 50 games as X and 50 games as O for seeds 0..99

EXPERIMENT_NAME = "01_baseline_uct_vs_tactical"
OUTPUT_CSV = output_folder() / f"{EXPERIMENT_NAME}.csv"


def make_tested_agent():
    return MCTSAgent.baseline_uct(simulations=SIMULATIONS)
