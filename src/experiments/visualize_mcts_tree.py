...
# Allows the file to run directly from PyCharm as well as through
# `python -m src.experiments.visualize_mcts_tree`.
...
# ---------------------------------------------------------------------------
# Configuration section: edit these values in PyCharm and run the file.
# ---------------------------------------------------------------------------
ROWS = 3
COLS = 3
WIN_LENGTH = 3
...
# Display controls. Keep these small for presentation readability.
MAX_DEPTH = 2
TOP_K_CHILDREN = 4
