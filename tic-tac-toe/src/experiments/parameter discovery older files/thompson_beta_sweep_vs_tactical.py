# ============================================================================
# WAS NOT USED IN FINAL TESTING - Runs resulted in floor effect for classical Thompson - all results were at 0%
# ============================================================================
...
# Test Thompson priors with random expansion and rollout and no guard.
# Symmetric priors are neutral; Beta(2, 1) is optimistic and Beta(1, 2)
# is pessimistic.
...
def main() -> None:
    print("=" * 80)
    print("Thompson Beta-prior sweep vs TacticalAgent")
    ...
    for label, alpha, beta in THOMPSON_PRIORS:
        experiment_name = f"thompson_{label}_vs_tactical"
