...
class MCTSTreeVisualizer:
    """Export a limited MCTS tree snapshot as Graphviz DOT.

    Depth and child limits keep the graph readable. Graphviz can also render
    the DOT file as PNG, SVG or PDF.
    """
    ...
    def export_graph(
        ...
        """Export DOT and render an image when Graphviz is available."""
...
def export_mcts_tree(
    ...
    """Export an MCTS tree snapshot and return its DOT and image paths."""
